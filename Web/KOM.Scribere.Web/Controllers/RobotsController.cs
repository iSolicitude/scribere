...
public class RobotsController : BaseController  
{
    ...
    public async Task SitemapXml()
    {
        ...
        await foreach (var post in posts)
        {
            var lastMod = new[] { post.PublishDate, post.ModifiedOn };
    ...
    private async Task<ISyndicationFeedWriter> GetWriter(string? type, XmlWriter xmlWriter, DateTimeOffset updated)
    {
        var host = $"{this.Request.Scheme}://{this.Request.Host}/";
