...
public class FileExtension : IBlogService
{
    ...
    public FileExtension(IWebHostEnvironment env, IHttpContextAccessor contextAccessor)
    {
        if (env is null)
        {
    ...
    public async Task SavePost(Post post)
    {
        ...
        var doc = new XDocument(
            new XElement("post",
                ...
                new XElement("PublishDate", FormatDateTime(post.PublishDate)),
                new XElement("lastModified", FormatDateTime(post.ModifiedOn)),
    ...
    private static string FormatDateTime(DateTimeOffset dateTime)
    {
        ...
        return dateTime.DateTime.Kind == DateTimeKind.Utc
    ...
    private void LoadPosts()
    {
        ...
        foreach (var file in Directory.EnumerateFiles(this.folder, "*.xml", SearchOption.TopDirectoryOnly))
        {
            ...
            var post = new Post
            {
                ...
                PublishDate = DateTime.Parse(ReadValue(doc, "PublishDate"), CultureInfo.InvariantCulture,
